...
public class LNGExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(LNGDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new LNGStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static LNGDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static LNGDateTimeConverter dateTimeConverter = new LNGStandardDateTimeConverter();

    public LNGExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public LNGExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new LNGMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=LNGHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,LNGExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=LNGHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
