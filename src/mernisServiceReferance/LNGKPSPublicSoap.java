...
public class LNGKPSPublicSoap
{
    ...
    public LNGKPSPublicSoap(){}

    public LNGKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public LNGKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        LNGExtendedSoapSerializationEnvelope envelope= new LNGExtendedSoapSerializationEnvelope(LNGExtendedSoapSerializationEnvelope.VER11);
